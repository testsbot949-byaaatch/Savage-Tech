...
module.exports = {
  ...
  description: 'Get crypto data (forex, crypto, stock, inflation, gdp, bankrate, wallet, gold, market, news)',
  async execute(sock, msg, args) {
    const from = msg.key.remoteJid;

    if (!args.length) {
      return sock.sendMessage(from, { text: '❓ Usage: .crypto <type> [param]\n\nTypes: forex, crypto, stock, inflation, gdp, bankrate, wallet, gold, market, news' }, { quoted: msg });
    }
